function CreateReport_STrisByRuns
...
for cS = 1:numRows
    ...
    data = newScores;
    figure
    StatBarPlot(data,'within',labels,mode,0,[]); %%Mask X Cond
    title([scoreRow.rs_ID,'T0 minus N0 X Run']);
...
for cS = 1:numRows
    ...
    figure
    StatBarPlot(data,'within',labels,mode,0,[]); %%Mask X Cond
    title([scoreRow.rs_ID,'T minus N X Run']);
    legend({'Run1','Run2','Run3','Run4'});
end
...
for cS = 1:numRows
    ...
    title([scoreRow.rs_ID,'S minus D2 X Run']);
    legend({'Run1','Run2','Run3','Run4'});
end
...
for cS = 1:numRows
    ...
    title([scoreRow.rs_ID,'D1 minus D2 X Run']);
    legend({'Run1','Run2','Run3','Run4'});
end
