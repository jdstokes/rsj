...
matlabbatch{1}.spm.spatial.preproc.channel.vols =  {fullfile(dir_mri,subj,hiresFold,hiresFile)};
...
matlabbatch{2}.spm.spatial.coreg.estwrite.ref = {fullfile(dir_mri,subj,hiresFold,['r',hiresFile])};
