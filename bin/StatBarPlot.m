function [Dm,Dse]=StatBarPlot(data,comp,labels,units,singlesub,legend_label)
...
% eachother, e.g.,rows would be ROIs Columns should be TT (S,D1,D2) and 
% (CA1,CA3,SUB)
...
plotmax=mean2(datamat)+(std2(datamat)*4);
