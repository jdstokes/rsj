function Voxel_selection_anova2(subj,C)
...
[pvals,~,~] = anovan(data_table_new.beta, { data_table_new.tt_code data_table_new.cityTargC}, ...
'model','interaction','varnames',{'TT' 'City'},'display','off');
