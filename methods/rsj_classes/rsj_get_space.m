classdef rsj_get_space
    ...
    methods
        ...
        function C  = VarFilter(rspace,C,var)
            
            curCombs = rspace.combs_curr;
            val = GetValue(C,var);
...
%             varInd = ~cellfun('isempty',strfind(rspace.struct,var));
            ...
            rspace.combs_curr = newCombs;
            rspace.opts = opts;
            C.space = rspace;
        end
        
        function C = VarReset(rspace,C,var)
            curCombs = rspace.combs_curr;
