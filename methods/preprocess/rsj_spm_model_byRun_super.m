function rsj_spm_model_byRun_super(subj,C)




C.spm.spm_modelName ='standard_ST_mr_run_super';%
...
matlabbatch{2}.spm.stats.fmri_spec.sess.multi_reg = {fullfile(dir_mri,subj,[spm_funcFold,num2str(runNum)],spm_motionFile)};
